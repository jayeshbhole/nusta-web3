    ...
    return (
        ...
        >
            <Heading as="h4" size="md">
                ** Both image and caption are required and you have to complete
                the validation to create a post so dont be an asshole and no
                need to dm me on discord that its not working **
            </Heading>
