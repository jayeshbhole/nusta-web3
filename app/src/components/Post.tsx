...
const Post = (props: Props) => {
    ...
    useEffect(() => {
        setLiked(
            likes?.findIndex(
                (like: any) => like?.id === auth?.currentUser?.uid
            ) !== -1
        );
    }, [likes]);
    ...
    return (
        ...
        >
            ...
            <Image
                src={
                    props?.posts?.image?.includes(
                        "https://firebasestorage.googleapis.com/v0/b/onlyuwuboi.appspot.com"
                    )
                        ? props?.posts?.image
                        : "/ohno.png"
                }
                        ...
                        <ModalContent>
                            ...
                            <ModalBody>
                                <Flex flexDirection="column" gap="1rem">
                                    ...
                                    <Radio colorScheme="red" value="1">
                                        Listen idk what i am doing with my lyfe
                                        help
                                    </Radio>
                                    <Radio colorScheme="red" value="1">
                                        Wait what ?
